...
const ru = {
  ...
  catalog: {
    ...
    filteredEmptyTitle: "GTIN по фильтрам не найдены", emptyTitle: "Каталог GTIN пока пуст", filteredEmptyDescription: "Измените запрос или сбросьте категории.", emptyDescription: "Синхронизируйте товары Znack, чтобы наполнить этот список.",
    title: "Локальный каталог GTIN", summary: "Загружено {count} · с правилами {mapped}", available: "{count} KIZ доступно",
    previousAria: "Предыдущая страница GTIN", previous: "Назад", page: "Страница {page}", nextAria: "Следующая страница GTIN", next: "Далее", loadMore: "Показать ещё", loadingMore: "Загружаем ещё…", loadMoreError: "Не удалось загрузить ещё", end: "Весь каталог загружен", added: "Добавлено: {count}",
  },
  ...
  editor: {
    ...
    saveError: "Не удалось сохранить соответствие", atomic: "Сохранение заменит правила только для этого GTIN.", cancel: "Отмена", saveAria: "Сохранить соответствие", saving: "Сохраняем…", save: "Сохранить",
  },
...
const en: KizMappingCopy = {
  ...
  editor: { dialogAria: "GTIN mapping {gtin}", close: "Close editor", loading: "Loading rules and owners…", eyebrow: "Mapping editor", title: "Categories → GTIN", description: "Each category and gender combination can belong to only one GTIN.", subjectsTitle: "WB categories", available: "{count} available", useSubject: "Use category {subject}{owner}", chooseSubjectAria: "Select category {subject}", occupiedSuffix: " · owned by {gtin}", gendersTitle: "Gender values", chooseSubject: "Select a category", noSubjects: "There are no local catalog categories to configure.", selectedTitle: "Selected rules", categories: "{count} categories", emptySelection: "Select categories and gender values. An empty list clears this GTIN mapping.", removeRule: "Remove rule {subject}", saveError: "Could not save the mapping", atomic: "Saving replaces rules for this GTIN only.", cancel: "Cancel", saveAria: "Save mapping", saving: "Saving…", save: "Save" },
...
const vi: KizMappingCopy = {
  ...
  catalog: { loadingAria: "Đang tải danh mục GTIN", loading: "Đang tải danh mục GTIN cục bộ…", errorTitle: "Không thể tải danh mục GTIN", errorDescription: "Dữ liệu cục bộ không thay đổi. Hãy thử lại.", retry: "Thử lại", filteredEmptyTitle: "Không tìm thấy GTIN phù hợp", emptyTitle: "Danh mục GTIN đang trống", filteredEmptyDescription: "Hãy đổi nội dung tìm kiếm hoặc xóa danh mục.", emptyDescription: "Hãy đồng bộ danh mục sản phẩm Znack để điền dữ liệu vào danh sách.", title: "Danh mục GTIN cục bộ", summary: "Đã tải {count} · {mapped} đã ánh xạ", available: "Có {count} KIZ", previousAria: "Trang GTIN trước", previous: "Trước", page: "Trang {page}", nextAria: "Trang GTIN sau", next: "Sau", loadMore: "Hiện thêm", loadingMore: "Đang tải thêm…", loadMoreError: "Không thể tải thêm", end: "Đã tải toàn bộ danh mục", added: "Đã thêm: {count}" },
...
const zh: KizMappingCopy = {
  ...
  catalog: { loadingAria: "正在加载 GTIN 目录", loading: "正在加载本地 GTIN 目录…", errorTitle: "无法加载 GTIN 目录", errorDescription: "本地数据未被修改，请重试。", retry: "重试", filteredEmptyTitle: "未找到匹配的 GTIN", emptyTitle: "GTIN 目录为空", filteredEmptyDescription: "请修改搜索内容或清除类别。", emptyDescription: "请同步 Znack 商品目录以填充此列表。", title: "本地 GTIN 目录", summary: "已加载 {count} 项 · 已映射 {mapped} 项", available: "{count} 个 KIZ 可用", previousAria: "上一页 GTIN", previous: "上一页", page: "第 {page} 页", nextAria: "下一页 GTIN", next: "下一页", loadMore: "显示更多", loadingMore: "正在加载更多…", loadMoreError: "无法加载更多", end: "已加载全部目录", added: "已添加：{count}" },
