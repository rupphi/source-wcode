...
export const defaultPrintSetupCopy: PrintSetupCopy = {
  ...
  cancelled: "Сохранение отменено. Файлы и история печати не создавались.", exportFailed: "Не удалось создать PDF.", pdfReady: "PDF готовы", pagesCreated: "Создано {count} страниц. Пути остаются только в Java; WCode показывает безопасные имена файлов.",
  ...
  errors: { tokenInvalid: "Проверьте API-токен и право Marketplace выбранного магазина.", rateLimited: "Wildberries ограничил запросы. Подождите несколько минут и повторите.", preflightFailed: "Проверьте сопоставление GTIN и доступные KIZ перед печатью.", unavailable: "Файлы не опубликованы. Проверьте соединение, доступ к папке и повторите." },
};
