...
const ru = {
  ...
  pagination: { aria: "Пагинация истории печати", previous: "Предыдущая страница истории", next: "Следующая страница истории", found: "Найдено", pageOf: "Страница {page} из {total}" },
...
const en: HistoryCopy = {
  ...
  pagination: { aria: "Print history pagination", previous: "Previous history page", next: "Next history page", found: "Found", pageOf: "Page {page} of {total}" },
...
const vi: HistoryCopy = {
  ...
  pagination: { aria: "Phân trang lịch sử in", previous: "Trang lịch sử trước", next: "Trang lịch sử sau", found: "Tìm thấy", pageOf: "Trang {page} / {total}" },
...
const zh: HistoryCopy = {
  ...
  pagination: { aria: "打印历史分页", previous: "上一页打印历史", next: "下一页打印历史", found: "找到", pageOf: "第 {page} 页，共 {total} 页" },
