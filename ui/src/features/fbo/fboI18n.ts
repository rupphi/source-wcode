...
const ru = {
  ...
  pagination: { label: "Пагинация FBO", previousAria: "Предыдущая страница FBO", previous: "Назад", loading: "Загружаем…", page: "Страница {page}", nextAria: "Следующая страница FBO", next: "Далее" },
  product: {
...
const en: FboCopy = {
  ...
  pagination: { label: "FBO pagination", previousAria: "Previous FBO page", previous: "Back", loading: "Loading…", page: "Page {page}", nextAria: "Next FBO page", next: "Next" },
...
const vi: FboCopy = {
  ...
  pagination: { label: "Phân trang FBO", previousAria: "Trang FBO trước", previous: "Trước", loading: "Đang tải…", page: "Trang {page}", nextAria: "Trang FBO sau", next: "Sau" },
...
const zh: FboCopy = {
  ...
  pagination: { label: "FBO 分页", previousAria: "上一页 FBO", previous: "上一页", loading: "正在加载…", page: "第 {page} 页", nextAria: "下一页 FBO", next: "下一页" },
