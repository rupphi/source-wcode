...
| Znack settings/products | `ZnackAutomationController` | editable safe settings snapshot plus bounded active/deleted product catalog and atomic hide/restore are covered by Java/React tests and isolated native lifecycle at 1440×857/960×640; certificate discovery/test, remote sync and permanent purge remain pending | Foundation (local) |
