...
- [x] Translate persisted Znack purchases, retry-introduction confirmation and sanitized logs
      in RU/EN/VI/ZH with locale formatting and a no-mutation browser rehearsal.
